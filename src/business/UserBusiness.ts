...
import { SignUpDTO, LoginDTO, GetAllUsersInputDTO } from "../dto/userDTO";
...
export class UserBusiness {
    ...
    public async getAllUsers(input: GetAllUsersInputDTO){
        ...
        if(payload.role !== ROLE_USER.ADMIN ){
            throw new BadRequestError('Você não tem permissão!')
        }
    ...
    public async login(input:LoginDTO ){
        ...
        if(password === undefined){            
            throw new BadRequestError("Informe uma senha")
        }
